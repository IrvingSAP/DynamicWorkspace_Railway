/**
 * TargetProfile — Paso 4 campos Excel (xlsx)
 */
(function () {
    "use strict";

    const root = document.getElementById("target-fields-xlsx-root");
    ...
    function cloneField(item) {
        return {
            ...
            excel_type: item.excel_type || "general",
    ...
    function readForm() {
        return {
            ...
            excel_type: document.getElementById("field-excel-type").value || "general",
    ...
    function writeForm(item) {
        ...
        document.getElementById("field-excel-type").value = item.excel_type || "general";
    ...
    function renderTable() {
        ...
        if (!fields.length) {
            tbody.innerHTML = (
                '<tr class="fields-empty-row"><td colspan="8">'
        ...
        tbody.innerHTML = fields.map(function (item, index) {
            return (
                ...
                + "<td><span class=\"cell-badge\">" + escapeHtml(item.excel_type) + "</span></td>"

...
STEP4_TEMPLATES = {
    "fixed": "file_clean/profile/step4_fields.html",
    "delimited": "file_clean/profile/step4_fields_delimited.html",
    "xlsx": "file_clean/profile/step4_fields_xlsx.html",
    "json": "file_clean/profile/step4_fields_json.html",
    "xml": "file_clean/profile/step4_fields_xml.html",
}

STEP4_HELP_TEMPLATES = {
    "fixed": "file_clean/profile/step4_help_fixed.html",
    "delimited": "file_clean/profile/step4_help_delimited.html",
    "xlsx": "file_clean/profile/step4_help_xlsx.html",
    "json": "file_clean/profile/step4_help_json.html",
    "xml": "file_clean/profile/step4_help_xml.html",
}
...
def hub(request, project_slug: str):
    return _render(request, project_slug, "file_clean/profile/hub.html")


@_profile_view
def hub_help(request, project_slug: str):
    return _render(request, project_slug, "file_clean/profile/hub_help.html")


@_profile_view
def step1_help(request, project_slug: str):
    return _render(request, project_slug, "file_clean/profile/step1_help.html", current_step=1)


@_profile_view
def step2_help(request, project_slug: str):
    return _render(request, project_slug, "file_clean/profile/step2_help.html", current_step=2)


@_profile_view
def step3_help(request, project_slug: str):
    return _render(request, project_slug, "file_clean/profile/step3_help.html", current_step=3)
...
def step4_help(request, project_slug: str):
    ...
    if not template:
        ...
        return redirect("file_clean:profile_step1", project_slug=project_slug)
    return _render(
        request,
        project_slug,
        template,
...
def step1_file_type(request, project_slug: str):
    ...
    return render(request, "file_clean/profile/step1_file_type.html", ctx)
...
def step2_capture_start(request, project_slug: str):
    ...
    return render(request, "file_clean/profile/step2_capture_start.html", ctx)
...
def step3_capture_end(request, project_slug: str):
    ...
    return render(request, "file_clean/profile/step3_capture_end.html", ctx)
...
def step4_fields_delimited(request, project_slug: str):
    return redirect("file_clean:profile_step4", project_slug=project_slug)
...
def profile_save(request, project_slug: str):
    ...
    if not redirect_to:
        redirect_to = reverse("file_clean:profile_hub", kwargs={"project_slug": project_slug})

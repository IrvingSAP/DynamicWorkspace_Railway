...
def hub(request, project_slug: str):
    return _render(request, project_slug, "reverse_studio/input/hub.html")


@_input_view
def hub_help(request, project_slug: str):
    return _render(request, project_slug, "reverse_studio/input/hub_help.html")


@_input_view
def step1_help(request, project_slug: str):
    return _render(request, project_slug, "reverse_studio/input/step1_help.html", current_step=1)


@_input_view
def step2_help(request, project_slug: str):
    return _render(request, project_slug, "reverse_studio/input/step2_help.html", current_step=2)


@_input_view
def step3_help(request, project_slug: str):
    return _render(request, project_slug, "reverse_studio/input/step3_help.html", current_step=3)
...
def step5_help(request, project_slug: str):
    return _render(request, project_slug, "reverse_studio/input/step5_help.html", current_step=5)


@_input_view
def step6_help(request, project_slug: str):
    return _render(request, project_slug, "reverse_studio/input/step6_help.html", current_step=6)
...
def step1_file_type(request, project_slug: str):
    ...
    ctx.update(input_wizard_service.get_step1_catalog_context())
    return render(request, "reverse_studio/input/step1_file_type.html", ctx)
...
def step2_capture_start(request, project_slug: str):
    ...
    return render(request, "reverse_studio/input/step2_capture_start.html", ctx)
...
def step3_capture_end(request, project_slug: str):
    ...
    return render(request, "reverse_studio/input/step3_capture_end.html", ctx)
...
def step5_content_rules(request, project_slug: str):
    ...
    return render(request, "reverse_studio/input/step5_content_rules.html", ctx)
...
def step6_report(request, project_slug: str):
    ...
    return render(request, "reverse_studio/input/step6_report.html", ctx)


@_input_view
@require_http_methods(["POST"])
def input_save(request, project_slug: str):
    project = _get_project_or_redirect(request, project_slug)
    if project is None:
    ...
    if raw:
        try:
            ...
            if request.headers.get("X-Requested-With") == "XMLHttpRequest":
                return JsonResponse(
                    {"ok": False, "message": "JSON de contrato de entrada inválido."},
                    status=400,
                )
            messages.error(request, "JSON de contrato de entrada inválido.")
    ...
    if not redirect_to:
        redirect_to = reverse("reverse_studio:input_hub", kwargs={"project_slug": project_slug})
